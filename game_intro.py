...
def apply_brightness(surface, level):
    """
    Apply brightness adjustment to the provided surface.

    Args:
    surface (pygame.Surface): The surface to adjust the brightness of.
    level (float): The brightness level to apply (0.0 - 2.0).
    """
...
def draw_second_page_logo():
    """
    Draw the logo and control buttons on the second page.

    This function displays the logo and control buttons (back, brightness, dim) on the second page.
    """
